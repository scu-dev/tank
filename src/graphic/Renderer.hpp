...
namespace Renderer {
    ...
    inline constexpr TextureID TX_FOOD_GUN       = 30;
    inline constexpr TextureID TX_FOOD_SHELL     = 31;
    inline constexpr TextureID TX_FOOD_STAR      = 32;
    inline constexpr TextureID TX_FOOD_TANK      = 33;
    inline constexpr TextureID TX_HOME           = 34;
    inline constexpr TextureID TX_HOME_DESTROYED = 35;
    inline constexpr TextureID TX_IRON           = 36;
